...
namespace SpaceInvader2023
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //Enemy Sprites
            AlienArray[0] = new Enemy(Content.Load<Texture2D>("alien"));
            AlienArray[1] = new Enemy(Content.Load<Texture2D>("alien"));
            AlienArray[2] = new Enemy(Content.Load<Texture2D>("alien"));
            AlienArray[3] = new Enemy(Content.Load<Texture2D>("alien"));
        }
